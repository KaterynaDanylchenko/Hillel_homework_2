...
num= input(f'Введіть число від 1 до {len(word)} тут>>>>>>>')
if int(num)<1  or  int(num)>len(word):
    print("Некоректне ім'я, допобачення")
else:
    print("The {} symbol in {} is {}".format(num,word,word[int(num)-1]))
...
lst_input= [1,2.3,'Katya',1466533,1456]
lst_output=[ ]
for i in lst_input:
