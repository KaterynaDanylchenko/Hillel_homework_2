...
class Triangle:
    ...
    def __str__(self):
        return f"""Vertices of a triangle: 
                    A = ({self.point1.x}, {self.point1.y})
                    B = ({self.point2.x}, {self.point2.y})
                    C = ({self.point3.x}, {self.point3.y})"""
...
trig1 = Triangle(point4, point2, point3)

print(trig.total_area)
print(trig1.total_area)
print(trig)
print(trig == trig1)
print(trig != trig1)
print(trig >= trig1)
