    ...
    for key in age_dict:
        if key == age_declension_for_1 and len(user_age) >= 4:
            ...
            if key == age_declension_for_1 and len(user_age) <= 4:
                ...
                age = arg_1
                return res_alternative,age

form_of_word_year=year_conjugation('1111111111')

user_age=form_of_word_year[-1]
user_age_final = int(user_age)
chek_num=(user_age[0])
...
if user_age_final<0:
    ...
    print('Тобі ж {} {}! Де твої батьки?'.format(user_age,form_of_word_year[0]))
elif user_age_final <= 10:
    print('Тобі лише {} {}, а це є фільм для дорослих!'.format(user_age, form_of_word_year[0]))
elif res == age_chek:
    print('О, вам {} {}! Який цікавий вік!'.format(user_age,form_of_word_year[0]))
elif user_age_final <= 16:
    print('Тобі лише {} {}, а це є фільм для дорослих!'.format(user_age,form_of_word_year[0]))
elif user_age_final > 65:
        print('Вам {} {}? Покажіть пенсійне посвідчення!'.format(user_age,form_of_word_year[0]))
else:
    print('Незважаючи на те, що вам {} {}, білетів всеодно нема!'.format(user_age,form_of_word_year[0]))
